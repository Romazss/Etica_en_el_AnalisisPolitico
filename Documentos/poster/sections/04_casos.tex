...
\vspace{0.2cm}
\begin{center}
    \includegraphics[width=0.48\linewidth]{imagenes/nf_en_tiempo_plesbicito.png}
    \hfill
    \includegraphics[width=0.48\linewidth]{imagenes/tematicas_nf_plesbicito.png}
    
    {\fontsize{14}{17}\selectfont \textit{Fuente: Plataforma Telar (M. Saldaña, PUC)}}
\end{center}
...
\begin{center}
\begin{tikzpicture}[node distance=1.0cm, auto, >=stealth, thick, scale=1.0, transform shape]
