...
\vspace{0.2cm}
\begin{center}
    \fcolorbox{uclight}{white}{\includegraphics[width=0.44\linewidth]{imagenes/nf_en_tiempo_plesbicito_opt.png}}
    \hfill
    \fcolorbox{uclight}{white}{\includegraphics[width=0.44\linewidth]{imagenes/tematicas_nf_plesbicito_opt.png}}
    
    % Fuente moved into title above (keep images visually clean)
\end{center}
...
{\fontsize{12}{14}\selectfont
    \begin{center}
        % Left reference panel: image + vertically centered label on its right
        \begin{minipage}{0.46\linewidth}\centering
            \begin{minipage}[c]{0.75\linewidth}\centering
                \includegraphics[width=0.6\linewidth]{imagenes/frame.png}
            \end{minipage}\hfill
        ...
        \end{minipage}
        \hfill
        % Right reference panel: image + vertically centered label on its right
        \begin{minipage}{0.46\linewidth}\centering
            \begin{minipage}[c]{0.75\linewidth}\centering
                \includegraphics[width=0.6\linewidth]{imagenes/frame2.png}
            \end{minipage}\hfill
            \begin{minipage}[c]{0.20\linewidth}\centering
